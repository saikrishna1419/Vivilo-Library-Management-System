                ...
                public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                    if (task.isSuccessful()) {
                        if (task.getResult().exists()) {
                            AlertDialog.Builder alert= new AlertDialog.Builder(RemoveBook.this);
                            ...
                            alert.setMessage(temp).setTitle("Please Confirm !").setCancelable(false).setPositiveButton("DELETE", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    {   progressDialog.cancel();
                                        Toast.makeText(RemoveBook.this, "This Book is issued to Users !\nReturn before Removing this Book.", Toast.LENGTH_LONG).show();
                            ...
                            progressDialog.cancel();
                            Toast.makeText(RemoveBook.this, "No such Book found !", Toast.LENGTH_SHORT).show();
                        }
                    } else {
                        progressDialog.cancel();
                        Toast.makeText(RemoveBook.this, "Try Again !", Toast.LENGTH_SHORT).show();
