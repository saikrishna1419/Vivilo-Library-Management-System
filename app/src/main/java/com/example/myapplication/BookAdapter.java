...
public class BookAdapter extends FirestoreRecyclerAdapter<Book, BookAdapter.Book> {
    ...
    @Override
    protected void onBindViewHolder(@NonNull Book holder, int position, @NonNull com.example.myapplication.Book model) {
    ...
    class Book extends RecyclerView.ViewHolder
    {
        ...
        TextView bookName,bookId,bookType,bookAvailable;
